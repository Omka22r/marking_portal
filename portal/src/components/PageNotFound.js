...
function ErrorPage(props) {
    ...
    return /^\#\/instructor$/.test(window.location.hash) || window.location.hash.startsWith("#/Student?") ?
        null
        : <Container style={{ height: '50vh' }} className="d-flex col-12  flex-column align-items-center justify-content-center">
